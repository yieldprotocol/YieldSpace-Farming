...
library YieldMath {
  ...
  public pure returns(uint128) {
    ...
    // za = vyDaiReserves ** a
    uint256 za = vyDaiReserves.pow(a, ONE);
  ...
  public pure returns(uint128) {
    ...
    // result = vyDaiReserves - (sum ** (1/a))
    uint256 result = uint256(vyDaiReserves) - uint256(uint128(sum).pow(ONE, a));
    require(result <= MAX, "YieldMath: Rounding induced error");
  ...
  public pure returns(uint128) {
    ...
    // result = (sum ** (1/a)) - vyDaiReserves
    uint256 result = uint256(uint128(sum).pow(ONE, a)) - uint256(vyDaiReserves);
    require(result <= MAX, "YieldMath: Rounding induced error");
