        ...
        for (var fyDaiReserveDelta of fyDaiReserveDeltas) {
          for (var tradeSize of tradeSizes) {
            for (var timeTillMaturity of timesTillMaturity) {
              console.log(`vyDaiReserve, fyDaiReserveDelta, tradeSize, timeTillMaturity`)
              console.log(`${vyDaiReserve}, ${fyDaiReserveDelta}, ${tradeSize}, ${timeTillMaturity}`)
              const fyDaiReserve = new BN(vyDaiReserve).add(new BN(fyDaiReserveDelta)).toString()
              let offChain, onChain
              offChain = sellFYDai(vyDaiReserve, fyDaiReserve, tradeSize, timeTillMaturity, 1.0)
              ...
              offChain = sellVYDai(vyDaiReserve, fyDaiReserve, tradeSize, timeTillMaturity, 1.0)
              ...
              offChain = buyVYDai(vyDaiReserve, fyDaiReserve, tradeSize, timeTillMaturity, 1.0)
              ...
              offChain = buyFYDai(vyDaiReserve, fyDaiReserve, tradeSize, timeTillMaturity, 1.0)
